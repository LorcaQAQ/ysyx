  ...
  val io = IO(new Bundle {
    ...
    val csignals =ListLookup(
      ...
      Array(
        ...
        SB -> List(REG_WRITE_X,OP1_RS1,OP2_IMMS,REG_DATA_X,ALU_ADD,NO_JUMP,MEM_WRITE,BYTE_U),
        BGE -> List(REG_WRITE_X,OP1_RS1,OP2_RS2_IMMB,REG_DATA_X,ALU_BGE,JUMP_COND,MEM_X,LOAD_Store_X),
        BEQ -> List(REG_WRITE_X,OP1_RS1,OP2_RS2_IMMB,REG_DATA_X,ALU_BEQ,JUMP_COND,MEM_X,LOAD_Store_X),
        SRLI -> List(REG_WRITE_EN,OP1_RS1,OP2_IMMI,REG_DATA_ALU,ALU_SRL,NO_JUMP,MEM_X,LOAD_Store_X),
        SLLI -> List(REG_WRITE_EN,OP1_RS1,OP2_IMMI,REG_DATA_ALU,ALU_SLL,NO_JUMP,MEM_X,LOAD_Store_X),
        BGEU -> List(REG_WRITE_X,OP1_RS1,OP2_RS2_IMMB,REG_DATA_X,ALU_BGEU,JUMP_COND,MEM_X,LOAD_Store_X),
        BLTU -> List(REG_WRITE_X,OP1_RS1,OP2_RS2_IMMB,REG_DATA_X,ALU_BLTU,JUMP_COND,MEM_X,LOAD_Store_X),
        SLT -> List(REG_WRITE_EN,OP1_RS1,OP2_RS2,REG_DATA_ALU,ALU_SLT,NO_JUMP,MEM_X,LOAD_Store_X),
        BLT -> List(REG_WRITE_X,OP1_RS1,OP2_RS2_IMMB,REG_DATA_X,ALU_BLT,JUMP_COND,MEM_X,LOAD_Store_X),
        LH -> List(REG_WRITE_EN,OP1_RS1,OP2_IMMI,REG_DATA_MEM,ALU_ADD,NO_JUMP,MEM_READ,Half_S),
        LHU -> List(REG_WRITE_EN,OP1_RS1,OP2_IMMI,REG_DATA_MEM,ALU_ADD,NO_JUMP,MEM_READ,Half_U),
        SRA -> List(REG_WRITE_EN,OP1_RS1,OP2_RS2,REG_DATA_ALU,ALU_SRA,NO_JUMP,MEM_X,LOAD_Store_X),
        SRL -> List(REG_WRITE_EN,OP1_RS1,OP2_RS2,REG_DATA_ALU,ALU_SRL,NO_JUMP,MEM_X,LOAD_Store_X),
        LB -> List(REG_WRITE_EN,OP1_RS1,OP2_IMMI,REG_DATA_MEM,ALU_ADD,NO_JUMP,MEM_READ,BYTE_S),
        ORI -> List(REG_WRITE_EN,OP1_RS1,OP2_IMMI,REG_DATA_ALU,ALU_OR,NO_JUMP,MEM_X,LOAD_Store_X),
        SLTI -> List(REG_WRITE_EN,OP1_RS1,OP2_IMMI,REG_DATA_ALU,ALU_SLT,NO_JUMP,MEM_X,LOAD_Store_X),
      )
    )
